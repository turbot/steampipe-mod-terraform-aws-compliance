...
benchmark "appsync" {
  ...
  children = [
    ...
    control.appsync_api_cache_encryption_at_transit_enabled,
...
control "appsync_graphql_api_field_level_logs_enabled" {
  ...
  description = "This control checks whether the field level logs are enabled for the AppSync GraphQL API."
...
control "appsync_api_cache_encryption_at_rest_enabled" {
  ...
  description = "This control checks whether the encryption at rest is enabled for the AppSync API cache."
...
control "appsync_api_cache_encryption_at_transit_enabled" {
  ...
  description = "This control checks whether the encryption at transit is enabled for the AppSync API cache."
  query       = query.appsync_api_cache_encryption_at_transit_enabled

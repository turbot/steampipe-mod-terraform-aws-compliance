...
control "efs_file_system_encrypted_with_kms_cmk" {
  title       = "EFS file system should be encrypted with KMS CMK"
  description = "This control checks whether the Elastic File System file system is encrypted with KMS CMK."

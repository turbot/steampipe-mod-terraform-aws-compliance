...
# TODO - terraform arguments dont include the parameters to be encrypted (Observastion - encrypting a cluster automatically encrypts the snapshots, need to look if this info can be used)
# control "foundational_security_rds_4" {

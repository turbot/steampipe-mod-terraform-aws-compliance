...
control "cis_v140_2_1_2" {
  ...
  # TODO: Update this query to check each bucket has an aws_s3_bucket_policy resource with the correct statements
...
control "cis_v140_2_1_5" {
  ...
  # TODO: Update this query to check each bucket has an aws_s3_bucket_public_access_block resource with the correct settings

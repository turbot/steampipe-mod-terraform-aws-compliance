...
- Renamed `steampipe.spvars.example` files to `powerpipe.ppvars.example` and updated documentation. ([#113](https://github.com/turbot/steampipe-mod-terraform-aws-compliance/pull/113))
